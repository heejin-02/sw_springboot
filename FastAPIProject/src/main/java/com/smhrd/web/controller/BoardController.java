...
public class BoardController {
	...
	// 데이터 흐름을 체크할 수 있는 log 찍는 도구를 꺼내오기
	...
	public String insert(Board board) {
		...
		if(result > 0) {
			// 2. board.jsp로 이동 (게시판에 추가한 게시글이 보여야 함)
			return "redirect:/";
		}else {
	...
	@GetMapping("/count")
	@ResponseBody
	// --> 페이지를 이동하는 메소드가 아니라, 비동기 통신을 처리하는 메소드임을 나타내는 annotation
